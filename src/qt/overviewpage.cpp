...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, check out the Kratom repository on GitHub"),
        tr("Services that claim to double your kratoms are always ponzi schemes")
    };
